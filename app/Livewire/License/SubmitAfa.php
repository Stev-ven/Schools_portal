...
class SubmitAfa extends Component
{
    ...
    public function back(){
        return redirect()->route('afadocument', ['applicationId'=> $this->application_id]);
    }
    public function render()
    {
        return view('livewire.license.submit-afa');
    }
}
