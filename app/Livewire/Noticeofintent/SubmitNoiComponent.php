...
class SubmitnoiComponent extends Component
{
    use LivewireAlert;
    ...
    public function back(){
        return redirect()->route('noticeofintentdocuments', ['applicationId'=> $this->application_id]);
    }
    public function render()
    {
        return view('livewire.noticeofintent.submitnoi-component');
    }
}
