                ...
                <div class="row md-12">
                    <div class="form-group">
                        <h2 style="font-family: 'Overpass', sans-serif;">
                            You need to make payment of GHC 1.00 to access
                            the Expression of Interest to establish a new school forms
                        </h2>
                    </div>
                        ...
                        <form class="kt-form" wire:submit.prevent="makePayment" action="#!">
                            <div class="row md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" readonly placeholder="Expression of Interest">
                                </div>
                                <div class="form-group">
