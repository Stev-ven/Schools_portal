        ...
        <form class="kt-form" action="#!">
            ...
            <div class="kt-portlet__foot">
                <div class="kt-form__actions kt-align-right">
                    ...
                    <button type="button" class="btn btn-outline-success btn-label-success" data-toggle="modal" data-target="#submitEoiModal">Submit & Complete</button>
                </div>
            </div>
        </form>
    </div>
                ...
                <div class="modal-body">
                    ...
                    <form id="confirmSubmissionForm">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-outline-success btn-label-success" wire:click="submitEoi" >submit & Finish</button>
                        </div>
                    </form>
                </div>
            </div>
