                ...
                <div class="row md-12">
                    <div class="form-group">
                        <h2 style="font-family: 'Overpass', sans-serif;">
                            You need to make payment of GHC 1.00 to access the
                            Application for Authorization to open a new school forms
                        </h2>
                    </div>

                <div class="kt-portlet__foot">
                    <div class="kt-form__actions">
                        <button type="button" class="btn btn-sm btn-bold" style="background-color: #636663; color: white;" wire:click="back">Go Back</button>
                        <button type="button" class="btn btn-sm btn-bold btn btn-success" data-toggle="modal" data-target="#makepaymentModal">Make Payment</button>
                    </div>
                </div>
                </div>
            </form>
                        ...
                        <form class="kt-form" wire:submit.prevent="makePayment" action="#!">
                            <div class="row md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" readonly placeholder="Application for authorization to open a school">
                                </div>
                                <div class="form-group">
                                    <label for="application">Amount (GHC)</label>
                                    <input type="text" class="form-control" readonly placeholder="1.00">
                                </div>
                            </div>
                            <div class="kt-portlet__foot">
                                <div class="kt-form__actions">
                                    <button type="button" class="btn btn-primary btn-sm btn-bold" data-dismiss="modal">Close</button>
                                    <button type="button" class="btn btn-sm btn-success btn-bold" wire:click="makePayment">
