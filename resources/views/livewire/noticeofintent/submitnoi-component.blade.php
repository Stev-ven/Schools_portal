        ...
        <form class="kt-form" action="#!">
            ...
            <div class="kt-portlet__foot">
                <div class="kt-form__actions kt-align-right">
                    ...
                    <button type="button" class="btn btn-sm btn-bold" style="background-color: #636663; color: white;">Preview Inputs</button>
                    <button type="button" class="btn btn-sm btn-bold btn btn-success" data-toggle="modal" data-target="#submitEoiModal">Submit & Complete</button>
                </div>
            </div>
        </form>
    </div>
                ...
                <div class="modal-body">
                    ...
                    <form id="confirmSubmissionForm">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-success" wire:click="submitNoi" >submit & Finish</button>
                        </div>
                    </form>
                </div>
            </div>
